      ...
      <div className="mx-auto max-w-[1200px] xl:max-w-[1440px] 2xl:max-w-[1720px] [@media(min-width:1920px)]:max-w-[1840px] px-5 sm:px-8 md:px-14 lg:px-20 xl:px-32 2xl:px-20 text-center">
        ...
        >
          {interfaces.map((item) => (
            <motion.div
              key={item.title}
              className="p-5 sm:p-6 text-left transition-all duration-300 hover:border-[#C8FF00]/20"
            ...
            >
              <h4 className="text-foreground text-[15px] sm:text-[15px] font-semibold mb-2">
                {item.title}
              </h4>
